...
export function hs_set_keycode(client, value, type, index, value2) {
...
export function he_custom_data_save(client, data) {
...
export function hs_get_light(client, mode) {
...
export function hs_set_light(client, value, data) {
...
export function hs_set_light_define(client, value) {
...
export function hs_set_light_define_infos(client, value) {
  if (value.length > 0) {
...
export function hs_get_light_box(client) {
  send_event(client, hs_format_data(client, PacketBuilder.begin(CMD_GET_LIGHT_BOX).build()));
}

export function hs_set_light_box(client, value) {
...
export function hs_set_axis_infos(client, value) {
  if (value.length > 0) {
...
export function hs_set_socd_data(client, value) {
...
export function hs_set_mt_data(client, value) {
...
export function hs_set_rs_data(client, value) {
...
export function hs_set_dks_data(client, value) {
...
export function hs_set_macro_data(client, value) {
...
export function hs_parse_cmd(client) {
  var i;
